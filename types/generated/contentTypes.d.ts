...
export interface ApiMyCollectionMyCollection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    myjson: Attribute.JSON;
    Dynamic: Attribute.Component<'new.dynamic'>;
    DynamicZone: Attribute.DynamicZone<['new-zone.zone', 'newzone1.zone1']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMytestMytest extends Schema.SingleType {
  collectionName: 'mytests';
  info: {
    singularName: 'mytest';
    pluralName: 'mytests';
    displayName: 'mytest';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::mytest.mytest': ApiMytestMytest;
    }
  }
}
